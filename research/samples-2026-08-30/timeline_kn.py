...
chs=["kyiv_nebo","kpszsu","war_monitor","nebo_raketa","AerisRimor","Ukrainian_Intelligence"]
short={"kyiv_nebo":"KN ","kpszsu":"PS ","war_monitor":"WM ","nebo_raketa":"NR ","AerisRimor":"AR ","Ukrainian_Intelligence":"UI "}
allm=[]
for c in chs:
